                            ...
                            <div className="space-y-4">
                                ...
                                >
                                    ...
                                    <div className="flex gap-4 items-center pl-2 relative z-10">
                                        ...
                                        <div>
                                            <span className="block text-[17px] tracking-wide font-bold text-slate-900 mb-1 transition-colors">20% Deposit <span className={`font-medium ml-2 text-sm transition-colors ${selectedTier === "20" ? "text-[#2563EB]/80" : "text-slate-500"}`}>(GHS 440)</span></span>
                                ...
                                >
                                    ...
                                    <div className="flex gap-4 items-center pl-2 relative z-10">
                                        ...
                                        <div>
                                            <span className={`block text-[17px] tracking-wide font-bold mb-1 transition-colors ${selectedTier === "50" ? "text-slate-900" : "text-slate-900"}`}>50% Half-Payment <span className={`font-medium ml-2 text-sm transition-colors ${selectedTier === "50" ? "text-[#2563EB]" : "text-blue-600/60"}`}>(GHS 1,100)</span></span>
                                ...
                                >
                                    ...
                                    <div className="flex gap-4 items-center pl-2 relative z-10">
                                        ...
                                        <div>
                                            <span className={`block text-[17px] tracking-wide font-bold mb-1 transition-colors ${selectedTier === "100" ? "text-slate-900" : "text-slate-900"}`}>100% Full Payment <span className="text-slate-500 font-medium ml-2 text-sm">(GHS 2,200)</span></span>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    >
                                        ...
                                        <div>
                                            ...
                                            <span className="text-sm text-slate-600">MTN MoMo, Telecel, AirtelTigo — pay with your phone.</span>
                                        </div>
                                    </button>
                                    <button
                                        type="button"
                                    ...
                                    >
                                        ...
                                        <div>
                                            ...
                                            <span className="text-sm text-slate-600">Visa, Mastercard — for those outside Ghana.</span>
                                        </div>
                                    </button>
                                </div>
