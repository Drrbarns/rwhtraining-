...
export default function MasterpieceHomepage() {
  ...
  return (
    <div className="bg-white text-slate-900 min-h-screen selection:bg-blue-600/20 selection:text-blue-900 font-sans overflow-x-hidden">
      ...
      <header className="fixed top-0 left-0 right-0 z-40 bg-white/95 backdrop-blur-md border-b border-slate-200 py-3 shadow-sm transition-all h-20 flex items-center">
        <div className="max-w-7xl mx-auto px-6 w-full flex items-center justify-between">
          ...
          <Link href="/" className="flex items-center gap-3 shrink-0">
            ...
            <div className="font-extrabold text-xl tracking-tight text-slate-900 hidden sm:flex items-baseline">
              Remote Work Hub
            </div>
          </Link>
          ...
          <nav className="hidden lg:flex items-center gap-8">
            {['Curriculum', 'Portfolio', 'Challenge', 'Internship'].map((item) => (
              <Link
                key={item}
          ...
          <div className="flex items-center gap-5 shrink-0">
            ...
            <Link href="/apply">
              <Button className="h-11 px-7 rounded-lg bg-blue-600 text-white hover:bg-blue-700 font-bold text-[14px] transition-all duration-300 shadow-md hover:shadow-lg">
                Secure Your Seat
              </Button>
            </Link>
          </div>
      ...
      <section className="relative pt-32 pb-24 md:pt-48 md:pb-40 min-h-[95vh] flex items-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 w-full">
          <div className="max-w-3xl">
            ...
            <motion.div initial="hidden" animate="visible" variants={STAGGER} className="flex flex-col items-start text-left bg-white/95 backdrop-blur-xl p-8 sm:p-12 rounded-[2rem] border border-white/40 shadow-2xl max-w-2xl">
              ...
              {/* Main Headline */}
              <motion.h1 variants={FADE_UP} className="text-4xl sm:text-5xl md:text-[3.5rem] font-extrabold tracking-tight text-slate-900 leading-[1.1] mb-6">
                ...
                <span className="text-slate-600 font-semibold tracking-tight text-2xl sm:text-3xl mt-3 block">
                  & Secure Your First Client in 30 Days.
                </span>
              </motion.h1>

              {/* Sub-headline */}
              <motion.p variants={FADE_UP} className="text-lg text-slate-600 mb-8 leading-relaxed max-w-xl">
              ...
              <motion.div variants={FADE_UP} className="grid sm:grid-cols-2 gap-4 mb-10 w-full">
                <div className="flex flex-col gap-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-[14px] font-bold text-slate-700">Starts March 16</span>
                  </div>
                </div>
                <div className="flex flex-col gap-4">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-[14px] font-bold text-slate-700">Paid Internship</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-6 h-6 rounded-full bg-blue-50 flex items-center justify-center shrink-0">
                      <CheckCircle2 className="w-4 h-4 text-blue-600" />
      ...
      <section className="py-24 bg-[#0a192f] text-white border-y border-[#112240]">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={STAGGER}>
              ...
              <motion.h2 variants={FADE_UP} className="text-4xl md:text-5xl font-extrabold tracking-tight leading-tight mb-6">
      ...
      <section id="curriculum" className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={STAGGER} className="text-center mb-16 max-w-3xl mx-auto">
            ...
            <motion.h2 variants={FADE_UP} className="text-3xl md:text-5xl font-extrabold tracking-tight text-slate-900 leading-tight mb-6">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={STAGGER} className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              { title: "Land Your First Client", desc: "Execute our proven lead generation outreach systems to sign your very first paying customer." },
            ].map((item, i) => (
              <motion.div
                key={item.title}
                variants={FADE_UP}
                className={`flex gap-5 p-8 rounded-2xl bg-slate-50 border border-slate-200 hover:border-blue-200 hover:shadow-lg transition-all ${i === 4 ? 'md:col-span-2 lg:col-span-1' : ''}`}
              >
      ...
      <section id="portfolio" className="py-24 bg-slate-100 border-y border-slate-200">
        <div className="max-w-7xl mx-auto px-6">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={STAGGER} className="text-center mb-16 max-w-3xl mx-auto">
            ...
            {[
              ...
              >
                <div className="w-12 h-12 rounded-lg bg-blue-50 flex items-center justify-center mb-5 group-hover:bg-blue-600 transition-colors">
                  <sys.icon className="w-6 h-6 text-blue-600 group-hover:text-white transition-colors" />
                </div>
                <h3 className="font-bold text-slate-900 text-lg mb-2">{sys.name}</h3>
                <p className="text-slate-500 text-sm leading-relaxed">{sys.desc}</p>
              </motion.div>
            ))}
          </motion.div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              variants={FADE_UP}
              className="bg-amber-50 rounded-3xl p-10 md:p-14 border border-amber-200"
            >
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              variants={FADE_UP}
              className="bg-slate-50 rounded-3xl p-10 md:p-14 border border-slate-200 flex flex-col justify-between"
            >
              <div>
                ...
                <h3 className="text-3xl md:text-4xl font-extrabold text-slate-900 mb-3 leading-tight">
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-blue-100 text-xl mb-10 max-w-2xl mx-auto leading-relaxed">
              Certification, internship, and aggressive mentorship included. We only accept 10 students per cohort to ensure extremely high-quality training.
            </p>

            <div className="flex justify-center gap-8 mb-10 text-white/90 font-medium">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-xl max-w-xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6 text-slate-900">
      ...
      <footer className="bg-[#0a192f] text-slate-400 py-16">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-12 border-b border-[#112240] pb-12 mb-8">
