...
export const SMS_TEMPLATES = {
  payment_confirmation: {
    ...
    body: `Hi {{first_name}}! Your payment of GHS {{amount}} ({{tier}}% tier) for the RWH Masterclass has been confirmed. Your seat is secured! Check your email for login details. - Remote Work Hub`,
  },
  balance_reminder: {
    name: "Balance Reminder SMS",
    category: "payment",
    variables: ["first_name", "balance"],
    body: `Hi {{first_name}}, you have an outstanding balance of GHS {{balance}} for the RWH Masterclass. Complete your payment to secure full access. Reply HELP for assistance. - RWH`,
  },
  session_reminder: {
    name: "Session Reminder SMS",
    category: "reminder",
    variables: ["first_name"],
    body: `Hi {{first_name}}! The RWH Masterclass starts tomorrow. Make sure your dev environment is ready. Log into your dashboard for the prep checklist. See you there! - RWH`,
  },
  abandoned_followup: {
    name: "Abandoned Application SMS",
    category: "retarget",
    variables: ["first_name"],
    body: `Hi {{first_name}}, you started your RWH Masterclass application but didn't finish. Seats are limited! Complete it now and start with just GHS 200. Visit remoteworkhub.org/apply - RWH`,
  },
  welcome_sms: {
    name: "Welcome SMS",
    category: "welcome",
    variables: ["first_name"],
    body: `Welcome to the RWH Masterclass, {{first_name}}! Your seat is secured. Check your email for login credentials and next steps. We start March 16! - Remote Work Hub`,
  },
