-- ⚠️ DANGER: Drops all existing tables related to the Masterclass
-- Run this FIRST in your Supabase SQL Editor to clean up the old schema
...
-- Drop existng ENUM types to avoid conflicts
...
-- =========================================================================
-- BELOW THIS LINE IS THE NEW UNIFIED SCHEMA (From our previous step)
-- =========================================================================
